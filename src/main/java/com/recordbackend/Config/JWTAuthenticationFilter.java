package com.recordbackend.Config;

import com.recordbackend.Service.JwtService;
import com.recordbackend.Service.SecurityTokenService;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        try {
            ...
            if (StringUtils.hasLength(userEmail) && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails) && securityTokenService.tokenExistsAndIsActivated(jwt)) {
